...
-   [x] 🦑-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:--:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-0b3log/vditor/issues/117?utm_source=hacpai.com#issuecomment-526986052);
...
### 4.  Ødelæggelser[流程图](https://github.com/knsv/mermaid#flowchart)

```mermaid
TD;
  B[Bidrag til ILLA Community<br>]
  A[Opret en AI Agent/ILLA App]-->B[Bidrag til ILLA Fællesskabet];
  B[Bidrag til ILLA Community]-->C[Indsend PR på GitHub];
  C[Indsend PR på GitHub]-->D[Win the prize];
```
...
### 5.  Ødelæggelser[序列图](https://github.com/knsv/mermaid#sequence-diagram)

```mermaid
sequenceDiagram
  deltager Alice
  deltager Bob
  Alice->John: Hej John, hvordan er du?
  loop Healthcheck
      John->John: Bekæmpelse af hypochondria
  ende
  Bemærk højre for John: rationelle tanker <br/>fremherskende. .
  John-->Alice: Great!
  John->Bob: Hvad med dig?
  Bob-->John: Jolly good!
```

### 6.  Ødelæggelser[甘特图](https://github.com/knsv/mermaid#gantt-diagram)
...
```echarts
{
  ...
  "title": {
    "text": "řłłłłłłłłłłłłłłłłłłłłłłłłłłłłłłłłotte",
    "subtext": "2019 řłłłłłotte"
    "x": "center",
    "textStyle": {
      "color": "#f2f2f2"
    }
...
| Rækkevidde - - | [http://quickapp.lovejade.cn](http://quickapp.lovejade.cn/??utm_source=markdown.lovejade.cn) | 2019-01-12 |

### 9.  更详细语法说明

opdateringen opdateres og opdateres og opdateres og opdateres og opdateres og opdateres og opdateres og opdateres og opdateres og opdateres og opdateres og opdateres og opdateres og opdateres og opdateres.
