...
description: Sobre ILLA Doc | ILLA Cloud
---
...
graph TD;
  ...
  A[Create an Agent/ILLA App]-->B[Contribute to ILLA Community];
  B[Contribuir a la comunidad ILLA]-->C[Enviar PR en GitHub];
  C[Enviar PR en GitHub]-->D[Gana el premio];
```
...
sequenceDiagrama
  participante Alice
  participante Bob
  Alice->John: Hola John, ¿cómo está?
  Bucle Healthcheck
      John->John: Fight against hypochondria
  end
  Nota derecho de John: Pensos racionales <br/>prevalecen. .
  John-->Alice: ¡Genial!
  John->Bob: ¿Qué tal tú?
  Bob-->John: ¡Bueno bien!
```
...
```echarts
{
  ...
  "título": {
    "text": "Ninguno": "Ninguno" de la Cámara de los Diputados,
    "subtexto": "2019 de 6 de la Cámara de Representantes,
    "x": "centro",
    "textStyle": {
      "color": "#f2f2f2"
    }
...
| Máxima      | [http://quickapp.lovejade.cn](http://quickapp.lovejade.cn/??utm_source=markdown.lovejade.cn) | 2019-01-12 |

### 9.  更详细语法说明

► Acompañamiento de correo electrónico (Markdown-tutorial)
