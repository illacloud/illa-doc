---
title: Om ILLA
description: Om ILLA Doc ∙ILLA Cloud
---
...
githubgithub[所见即所得](https://hacpai.com/article/1577370404903?utm_source=github.com)″,githubgithubMIRAPEX`^ -illu-M`(`Ctrl-buti-M`)mechanical mechanical githubgithubgithubgithubgithubgithubεεεεε″：
...
-   [x] 🦑 ″″″″″″″″″unnelbεεεεεεephalephalephalminecraft](https://github.com/b3log/vditor/issues/117?utm_source=hacpai.com#issuecomment-526986052);
...
```mermaid
graf TD;
  B[Bidra til ILLA Community<br>]
  A[Lag en AI Agent/ILLA App]-->B[Bidra til ILLA samfunn];
  B[Contribute to ILLA Community]-->C[Send PR on GitHub];
  C[Send PR on GitHub]-->D[Win prisen];
```
...
### 5.  Conoco″″″″[序列图](https://github.com/knsv/mermaid#sequence-diagram)

```mermaid
sequDiagram
  participant Alice
  deltager Bob
  Alice->John: Hello John, hvordan er du?
  loop Healthcheck
      John->John: Fight against hypochondria
  end
  Note right of John: Rational thoughts <br/>seier. .
  John-->Alice: Flott!
  John->Bob: Hva med deg?
  Bob-->John: Jolly good!
```

### 6.  ➜ ″″″″[甘特图](https://github.com/knsv/mermaid#gantt-diagram)
...
| ∙odarodarue. ind | [http://quickapp.lovejade.cn](http://quickapp.lovejade.cn/?utm_source=markdown.lovejade.cn) | 2019-01-12 |

### 9.  更详细语法说明

➜ ″″″″″″″″″″″,″,εεbutibutibutibutibutiφ \[Markdown - https://github.com/nicejade/nice-front-end-veiledning/blob/master/tutorial/markdown-tutorial.md) .md),redirediredirediredió ó εεε″″″″″″far. far. pære, clar(1(1(1(1(1(1(1))-)-)-)-)-)-)-)-)-)-)-)-
