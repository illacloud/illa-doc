---
title: Sobre a ILLA
description: Sobre a ILLA Doc ,ILLA Cloud
---
...
(ExplicitText="[所见即所得](https://hacpai.com/article/1577370404903?utm_source=github.com)➲ ,├format@@0(https://hacpai.com/article/1577370404903?utm_source=github.com,thanking：
...
-   [x] 🦑 ├├├├├├├[├├├├├├├├├├├├](https://github.com/b3log/vditor/issues/117?utm_source=hacpai.com#issuecomment-526986052);
...
```mermaid
gráfico TD;
  B[Contribuir com a Comunidade ILLA<br>]
  R[Criar um Agente IA/ILLA App]-->B[Contribuir para a Comunidade ILLA];
  B[Contribua à comunidade ILLA]-->C[Enviar PR no GitHub];
  C[Enviar PR no GitHub]-->D[Ganhe o prêmio];
```
...
### 5.  (ExplicitText="├[序列图](https://github.com/knsv/mermaid#sequence-diagrama)
...
### 6.  (ExplicitText="├[甘特图](https://github.com/knsv/mermaid#gantt-diagram)
...
| rebenta,rebentavel | [http://quickapp.lovejade.cn](http://quickapp.lovejade.cn/??utm_source=markdown.lovejade.cn) | 2019-01-12 |

### 9.  更详细语法说明

rebentonamed@@ginásia&ginásia:trade_mark,├├├&&&Markdown ^\\](https://github.com/nicejade/nice-front-end-tutorial/blob/master/tutorial/markdown-tutorial.md),├├├├├&&&remplo,├├,├├├├├├&&&&&&rrrr&&&&&&&&&&&&&&&&&&rrr,&&&&,,,&,&&,&,&,&&,&,&,&&&,&,&,&r_dicato de
