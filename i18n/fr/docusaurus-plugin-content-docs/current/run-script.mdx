...
| description         | Utilisé pour définir la description                               | Chaîne de caractères                                                                           | description : "Récupération réussie"  |
...
| Timeline                                                                                                                                                                                    | `string`, Séparez les valeurs des différents nœuds par des virgules (,) | `timeline1.setValue("The first milestone,The second milestone")`                                                                                                                                    |
...
| Groupe de cases à cocher, Cascader                                                                                                                                                          | `array`                                                                 | `cascader1.setValue(["media_source_2","campaign_2-1"])`                                                                                                                                             |
