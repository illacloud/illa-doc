---
title: MySQL
description: Connect and interact with a MySQL database using ILLA Cloud. Create apps that can query, manipulate, and visualize data. Automate and optimize data workflows.
---
