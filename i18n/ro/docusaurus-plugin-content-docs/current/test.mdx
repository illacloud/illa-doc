---
title: Despre ILLA
description: Despre ILLA Doc <unk> ILLA Cloud
---
...
-   [x] 🦑 <unk> <unk> <unk> <unk> ... \[<unk> <unk> <unk> <unk> Τηλαπουργία (https://github.com/b3log/vditor/issues/117?utm_source=hacpai.com#issuecomment-526986052);
...
### 4.  <unk> <unk>[流程图](https://github.com/knsv/mermaid#flowchart)

```mermaid
graph TD;
  B[Contribute to ILLA Community<br>]
  A[Create an AI Agent/ILLA App]-->B[Contribute to ILLA Community ILLA ];
  B[Contribute to ILLA Community]-->C[Submit PR on GitHub];
  C[Submit PR on GitHub]-->D[Câștigă premiul];
```
...
### 5.  <unk> <unk>[序列图](https://github.com/knsv/mermaid#sequence-diagram)

```mermaid
secvența Diagrama
  participant Alice
  Bob
  Alice->John: Bună John, cum ești?
  loop Healthcheck
      John->John: Luptă împotriva hipochondria
  end
  Nota la dreapta a John: prevalează gândurile raţionale <br/>. .
  John-->Alice: Grozav!
  John->Bob: Ce zici de tine?
  Bob-->John: Jolly good!
```

### 6.  <unk> <unk>[甘特图](https://github.com/knsv/mermaid#gantt-diagram)
...
```echarts
{
  ...
  "title": {
    "text": "Astepti <unk> <unk> <unk> α",
    "subtext": "2019 <unk> 6 <unk> ",
    "x": "centru",
    "textStyle": {
      "color": "#f2f2f2f2"
    }
...
| urm.        | [http://quickapp.lovejade.cn](http://quickapp.lovejade.cn/?utm_source=markdown.lovejade.cn) | 2019-01-12 |

### 9.  更详细语法说明

TUTĂ-AMENTE, TARI SPECIAL, Asta format@@0 format@@0 format@@0 format@@0 OBŢINE_TARIF format@@0 ](https://github.com/nicejade/nice-front-end-tutorial/blob/master/tutorial/markdown-tutorial.md),, fitfiteatoxici logici logici, fiteatologici legislati, imperceptibil, teoretic
