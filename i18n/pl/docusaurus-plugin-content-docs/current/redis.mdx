---
title: Redis
description: Discover how to connect and interact with your Redis database using ILLA Cloud's database integration feature. Check out this guide for more details.
---
