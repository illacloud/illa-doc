---
title: Time Range
description: Learn how to use the Time Range component from ILLA Cloud to let users select a range of times from a 24-hour interface in your applications.
---
