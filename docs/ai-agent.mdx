...
<div style={{
    ...
    height: 0
    }}><iframe src="https://demo.arcade.software/fwmhuHAjP5Uw7ZtAwMT0?embed" frameborder="0" loading="lazy" webkitallowfullscreen={true}={true} mozallowfullscreen={true}={true} allowfullscreen={true} style={{position: "absolute", top: 0, left: 0, width: "100%", height: "100%", colorScheme: "light"}}></iframe></div>
...
<div style={{
    ...
    paddingBottom: "calc(56.81216931216932% + 41px)", 
    height: 0
    }}><iframe src="https://demo.arcade.software/IgfpeApp6wqThN71Pzlg?embed" frameborder="0" loading="lazy" webkitallowfullscreen={true}={true} mozallowfullscreen={true}={true} allowfullscreen={true} style={{position: "absolute", top: 0, left: 0, width: "100%", height: "100%", colorScheme: "light"}}></iframe></div>
...
<div style={{
    ...
    paddingBottom: "calc(56.81216931216932% + 41px)", 
    height: 0
    }}><iframe src="https://demo.arcade.software/DmI2hHqM4kShp8jP7utN?embed" frameborder="0" loading="lazy" webkitallowfullscreen={true}={true} mozallowfullscreen={true}={true} allowfullscreen={true} style={{position: "absolute", top: 0, left: 0, width: "100%", height: "100%", colorScheme: "light"}}></iframe></div>
...
<div style={{
    ...
    paddingBottom: "calc(56.81216931216932% + 41px)", 
    height: 0
    }}><iframe src="https://demo.arcade.software/Y8sq05zA0uis9e0oC39z?embed" frameborder="0" loading="lazy" webkitallowfullscreen={true}={true} mozallowfullscreen={true}={true} allowfullscreen={true} style={{position: "absolute", top: 0, left: 0, width: "100%", height: "100%", colorScheme: "light"}}></iframe></div>
...
<div style={{
    ...
    paddingBottom: "calc(56.81216931216932% + 41px)", 
    height: 0
    }}><iframe src="https://builder.illacloud.com/illacloud_demo/deploy/app/ILAfx4p1C71f" frameborder="0" loading="lazy" webkitallowfullscreen={true}={true} mozallowfullscreen={true}={true} allowfullscreen={true} style={{position: "absolute", top: 0, left: 0, width: "100%", height: "100%", colorScheme: "light"}}></iframe></div>
